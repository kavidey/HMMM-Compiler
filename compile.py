...
def parse_binary_op(node: pycparser.c_ast.BinaryOp, program: HmmmProgram) -> None:
    ...
    unused_registers = find_unused_registers(used_registers.union({HmmmRegister.R13, HmmmRegister.R14, HmmmRegister.R15}))
    ...
    ### Operation ###
    if node.op == "+":
        program.add_instruction(generate_instruction("add", left_register, right_register, HmmmRegister.R13))
    elif node.op == "-":
        program.add_instruction(generate_instruction("sub", left_register, right_register, HmmmRegister.R13))
    elif node.op == "*":
        program.add_instruction(generate_instruction("mul", left_register, right_register, HmmmRegister.R13))
    elif node.op == "/":
        program.add_instruction(generate_instruction("div", left_register, right_register, HmmmRegister.R13))
    elif node.op == "%":
